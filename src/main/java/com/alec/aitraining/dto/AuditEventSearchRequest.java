...
public record AuditEventSearchRequest(
		...
		@Schema(description = "Filter events recorded at or after this timestamp (ISO-8601)", example = "2025-01-01T00:00:00Z") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) Instant from,
		@Schema(description = "Filter events recorded at or before this timestamp (ISO-8601)", example = "2025-12-31T23:59:59Z") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) Instant to) {
}
